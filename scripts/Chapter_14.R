## Chapter 14: Employee Performance Analysis
...
employee_data <- read.csv("https://raw.githubusercontent.com/jtmonroe252/Data-to-Decisions/main/data/employee_data.csv")
