## Chapter 15: Employee Turnover Analysis
...
turnover_data <- read.csv("https://raw.githubusercontent.com/jtmonroe252/Data-to-Decisions/main/data/turnover_data.csv")
...
legend("bottomleft", legend = unique(turnover_data$Department), col = rainbow(length(unique(turnover_data$Department))), lwd = 2)
